...
//String email = Email.getText();
//UserProfileScreen userProfileEmail = new UserProfileScreen(ProfileScrTxt);
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("I already have an account");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(PasswordConf, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ProfileScrTxt = UserName.getText();
    String email =  Email.getText();
    String user =UserName.getText();
    ...
    addSignUpData(email, pass);
     
     Password.setText("");
        Email.setText("");
    String id=ID.getText();
     if (user.isEmpty() || pass.isEmpty() || passConf.isEmpty() || email.isEmpty() || phone.isEmpty() || gender.equals("Choose Gender :") || id.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please fill in all the fields", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
if (!pass.equals(passConf)) {
        JOptionPane.showMessageDialog(this, "Password and Password Confirmation do not match", "Error", JOptionPane.ERROR_MESSAGE);
        Password.setText("");
...
JOptionPane.showMessageDialog(this, "Account created successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
   ...
   Frames LoginFrame=new Frames();
        LoginFrame.pack();
        LoginFrame.setVisible(true);       
        LoginFrame.setLocationRelativeTo(null);
        this.dispose();
   /*userProfileUser.pack();
    userProfileUser.setVisible(true);       
    userProfileUser.setLocationRelativeTo(null);
    this.dispose();*/}
    private void addSignUpData(String email, String password) {
        SignUpData newSignUpData = new SignUpData(email, password);
        Frames.addSignUpData(newSignUpData);
    }
